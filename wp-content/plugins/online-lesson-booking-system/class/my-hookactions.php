...
EOD;
	 ...
	 */
	public function ex_newuser_fields( $user ) {
		$html = '';
	 ...
	 */
	public function ex_newuser_profile( $html, $user ) {
		global $pagenow;
...
EOD;
	 ...
	 */
	public function save_ex_newuser_fields( $user_id ) {

		if ( ! current_user_can( 'edit_user', $user_id ) ) {
			return false;
		}
		if ( isset( $_POST['olbgroup'] ) ) {
			update_usermeta( $user_id, 'olbgroup', $_POST['olbgroup'] );
		}
	}
